...
class PostRegistroDocenteActivity : AppCompatActivity() {
    ...
    private fun setup(email: String) {
        ...
        bElegirFoto.setOnClickListener {
    ...
    private fun uploadToDB(email: String, password: String) {
        ...
        bContinuarHome.setOnClickListener{
            //seccion para nombre completo y rol
            if(editTextNombreCompleto.text.toString().isEmpty())
                ...
                //Aqui el docente ha registrado correctamente un nombre, asi que registramos el usuario y damos de alta su documento
